...
- Библиотеки: `pandas`, `numpy`, `requests`, `web3.py`, `stable-baselines3` (для PPO), `matplotlib` (для визуализации).
...
- [ ] Установить Python 3.9+ и необходимые библиотеки (`pandas`, `numpy`, `requests`, `web3.py`, `stable-baselines3`).
- **Описание:** Создать виртуальное окружение и убедиться, что все зависимости работают.
- **Результат:** Файл `requirements.txt` и рабочая среда.
- **Зависимости:** Доступ к терминалу, pip.

#### Задача 1.2: Подключение к Binance API
- [ ] Реализовать функцию для получения текущей цены (\( S_t \)) и глубины книги ордеров для пар USD+/wETH и USD+/cbbtc через Binance API.
...
- [ ] Реализовать функцию для вычисления волатильности на основе исторических данных.
...
- **Описание:** Использовать `stable-baselines3`, 10,000 итераций.
...
- **Описание:** Использовать `matplotlib`.
